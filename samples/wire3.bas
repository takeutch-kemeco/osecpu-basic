...
/* 0 1 2 3 */
        ...
        if (va[2] >= 0) drawline 0 vts[0]@v[0] vts[0]@v[1] vts[1]@v[0] vts[1]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[1]@v[0] vts[1]@v[1] vts[2]@v[0] vts[2]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[2]@v[0] vts[2]@v[1] vts[3]@v[0] vts[3]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[3]@v[0] vts[3]@v[1] vts[0]@v[0] vts[0]@v[1] col;

/* 4 5 6 7 */
        col=torgb 0 255 0;
        mat va=vtx[4]@v - vtx[5]@v; mat vb=vtx[6]@v - vtx[5]@v; mat va=va * vb;
        if (va[2] >= 0) drawline 0 vts[4]@v[0] vts[4]@v[1] vts[5]@v[0] vts[5]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[5]@v[0] vts[5]@v[1] vts[6]@v[0] vts[6]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[6]@v[0] vts[6]@v[1] vts[7]@v[0] vts[7]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[7]@v[0] vts[7]@v[1] vts[4]@v[0] vts[4]@v[1] col;

/* 4 5 1 0 */
        col=torgb 0 0 255;
        mat va=vtx[5]@v - vtx[4]@v; mat vb=vtx[1]@v - vtx[5]@v; mat va=va * vb;
        if (va[2] >= 0) drawline 0 vts[4]@v[0] vts[4]@v[1] vts[5]@v[0] vts[5]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[5]@v[0] vts[5]@v[1] vts[1]@v[0] vts[1]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[1]@v[0] vts[1]@v[1] vts[0]@v[0] vts[0]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[0]@v[0] vts[0]@v[1] vts[4]@v[0] vts[4]@v[1] col;

/* 5 6 2 1 */
        col=torgb 255 255 0;
        mat va=vtx[6]@v - vtx[5]@v; mat vb=vtx[2]@v - vtx[6]@v; mat va=va * vb;
        if (va[2] >= 0) drawline 0 vts[5]@v[0] vts[5]@v[1] vts[6]@v[0] vts[6]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[6]@v[0] vts[6]@v[1] vts[2]@v[0] vts[2]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[2]@v[0] vts[2]@v[1] vts[1]@v[0] vts[1]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[1]@v[0] vts[1]@v[1] vts[5]@v[0] vts[5]@v[1] col;

/* 6 7 3 2 */
        col=torgb 0 255 255;
        mat va=vtx[7]@v - vtx[6]@v; mat vb=vtx[3]@v - vtx[7]@v; mat va=va * vb;
        if (va[2] >= 0) drawline 0 vts[6]@v[0] vts[6]@v[1] vts[7]@v[0] vts[7]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[7]@v[0] vts[7]@v[1] vts[3]@v[0] vts[3]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[3]@v[0] vts[3]@v[1] vts[2]@v[0] vts[2]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[2]@v[0] vts[2]@v[1] vts[6]@v[0] vts[6]@v[1] col;

/* 7 4 0 3 */
        col=torgb 255 0 255;
        mat va=vtx[4]@v - vtx[7]@v; mat vb=vtx[0]@v - vtx[4]@v; mat va=va * vb;
        if (va[2] >= 0) drawline 0 vts[7]@v[0] vts[7]@v[1] vts[4]@v[0] vts[4]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[4]@v[0] vts[4]@v[1] vts[0]@v[0] vts[0]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[0]@v[0] vts[0]@v[1] vts[3]@v[0] vts[3]@v[1] col;
        if (va[2] >= 0) drawline 0 vts[3]@v[0] vts[3]@v[1] vts[7]@v[0] vts[7]@v[1] col;
