...
*LLL;
        ...
        draw_W4(vts[0], vts[1], vts[2], vts[3], (torgb 255 0 0));   /* 0 1 2 3 */
        draw_W4(vts[4], vts[5], vts[6], vts[7], (torgb 0 255 0));   /* 4 5 6 7 */
        draw_W4(vts[4], vts[5], vts[1], vts[0], (torgb 0 0 255));   /* 4 5 1 0 */
        draw_W4(vts[5], vts[6], vts[2], vts[1], (torgb 255 255 0)); /* 4 5 2 1 */
        draw_W4(vts[6], vts[7], vts[3], vts[2], (torgb 0 255 255)); /* 6 7 3 2 */
        draw_W4(vts[7], vts[4], vts[0], vts[3], (torgb 255 0 255)); /* 7 4 0 3 */
